...
var MeshoptDecoder = (function () {
  ...
  var wasmpack = new Uint8Array([
    32, 0, 65, 2, 1, 106, 34, 33, 3, 128, 11, 4, 13, 64, 6, 253, 10, 7, 15, 116, 127, 5, 8, 12, 40,
    16, 19, 54, 20, 9, 27, 255, 113, 17, 42, 67, 24, 23, 146, 148, 18, 14, 22, 45, 70, 69, 56, 114,
    101, 21, 25, 63, 75, 136, 108, 28, 118, 29, 73, 115,
  ]);
  ...
  function decodeWorker(count, size, source, mode, filter) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      worker.object.postMessage(
        { id: id, count: count, size: size, source: data, mode: mode, filter: filter },
        [data.buffer],
      );
    });
  }

-- TREMENDO CHICHARRON - Opciones de proteina por producto y por comanda
...
begin
  ...
  if v_telefono <> p_telefono then raise exception 'El telefono no corresponde al pedido'; end if;
  ...
  insert into public.pedido_items (
    ...
    variante_personas, combo, proteina, notas, precio_unitario
  )
  select
    p_pedido_id,
